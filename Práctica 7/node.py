...
class Node:
    def __init__(self, name):
        ...
        self.parent = None
        self.discovered = math.inf
        self.finished = math.inf
    ...
    def __repr__(self):
        ...
        return base.format(self.name, self.color.value, self.distance, hasParent, self.discovered, self.finished,
                           self.__neighborsToString())
